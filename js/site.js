    ...
    "updates": [
        {
		...
		
		 {
            ...
            "link": "https://www.inderscience.com/info/ingeneral/forthcoming.php?jcode=ijitst",
        },
		 {
            "date": "January 9, 2020",
...
var researchInterest = {
    "interests": [
        ...
        {
            "name": "Parallel Computing, Systolic Arrays, Computer Arhitecture",
            "text": 'Check my publications',
            "links": [
                {
                    "text": "View Publications",
        ...
        {
            "name": "Convolutional and Deep Learning Neural Networks",
            "text": 'Check my publications',
            "links": [
                {
                    "text": "View Publications",
...
var contacts = {
    "contact":
    {
        ...
        "lab": "Room 561, System on Chips (SoC) Lab, 8B",
        "department": "Eletronics Engineering Block,Incehon National University",
...
function displayHonorsAwards() {
    ...
    honorsAwards.honors.forEach(function (honor) {
        ...
        myList += '<li><h4>' + honor.title + ' <span style="float:right; font-style:italic; text-decoration:underline ">' + honor.comments + '</span></h4><p>' + honor.detail + '</p><a href="' + honor.link + '" target="_blank"><p style="text-decoration:underline">Click to see the Award</p></a></li>';
    });
    myList += '</ul>';
